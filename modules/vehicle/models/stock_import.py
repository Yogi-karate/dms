...
class StockImport(models.Model):
    ...
    def _create_inventory_adjustment(self):
        adj_vals = {"state":"confirm",
                    ...
                    "product_uom_category_id":1,"theoretical_qty":0,"state":"confirm"}]],
                    "move_ids":[],"id":1},
        "line_ids",{"state":"1","name":"","location_id":"1","filter":"1","date":"","accounting_date":"","company_id":"","product_id":"","category_id":"","lot_id":"","partner_id":"","package_id":"","exhausted":"","line_ids":"1","line_ids.product_tracking":"","line_ids.product_id":"1","line_ids.product_uom_id":"1",
                    "line_ids.product_uom_category_id":"","line_ids.location_id":"1","line_ids.prod_lot_id":"1","line_ids.package_id":"1","line_ids.partner_id":"1",
                    "line_ids.theoretical_qty":"","line_ids.product_qty":"","line_ids.state":"","move_ids":"","move_ids.product_id":"1","move_ids.picking_id":"","move_ids.create_date":"","move_ids.date_expected":"1","move_ids.scrapped":"","move_ids.state":"","move_ids.location_id":"","move_ids.location_dest_id":"1","move_ids.quantity_done":"","move_ids.product_uom":"1"},